...
Usage
ActionHowShorten a URLPaste into the input, hit ShortenVisit a short linkGo to http://localhost:5000/xxxxxxCopy a linkClick the copy button next to any recent linkView statsNavigate to http://localhost:5000/statsStop the serverCtrl + C in the terminal
